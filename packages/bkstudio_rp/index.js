...
setInterval(function(){
	try {
		...
		mp.players.forEach(player => {
			...
			if(timer15minutes === 0)	{
				player.outputChatBox("<font color='#FFA500'>============ [ Объявления ] ============</font><br>Сайт: <font color='green'>BKStudio.com.ua</font><br>Чтобы посмотреть список игроков нажмите <font color='green'>[Z]</font>.<br>=======================================");
